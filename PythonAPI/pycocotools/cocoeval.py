    ...
    def summarize(self):
        ...
        def _summarizeDets():
            if len(self.params.maxDets)==1:
                ...
                stats[12] = _summarize(0, areaRng='micro', maxDets=self.params.maxDets[-1])
                stats[13] = _summarize(0, areaRng='v-tiny', maxDets=self.params.maxDets[-1])
                stats[14] = _summarize(0, areaRng='tiny', maxDets=self.params.maxDets[-1])
